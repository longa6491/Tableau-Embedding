...
// making a function to log info about a workbook
function logWorkbookInformation() {
    ...
    sheets.forEach((element) => {index = element.index; console.log(`The Sheet with index [${index}] is : "${element.name}"`)});

    vizActiveSheet = workbook.activeSheet;
    console.log(`This active sheet is : "${vizActiveSheet.name}"`);

    listSheets = vizActiveSheet.worksheets;

    listSheets.forEach((element) => {index= element.index; 
